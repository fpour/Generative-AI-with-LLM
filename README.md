...
**Reference**: [Generative AI with LLM github repo](https://github.com/Ryota-Kawamura/Generative-AI-with-LLMs/tree/main).
...
[Lab 1 - Generative AI Use Case: Summarize Dialogue](https://github.com/fpour/Generative-AI-with-LLM/blob/main/lab_1_summarize_dialogue.py)
